...
<head>
    ...
    <title>Lihat Barang - Admin InfoMotive</title>
    ...
    <style>
        ...
        .view-card {
            background: white;
            border-radius: 12px;
            box-shadow: 0 5px 20px rgba(0,0,0,0.08); /* Matches screenshot shadow */
            padding: 40px;
            position: relative;
        ...
        .btn-back {
            ...
            border-radius: 4px; /* Slightly rounded like screenshot */
            display: flex;
            align-items: center;
...
<body>
    ...
    <div class="container">
        ...
        <div class="breadcrumb">
            Barang <span style="font-weight: 400; color: #333;">/ Lihat Barang</span>
        </div>

        <div class="view-card">
            <!-- Top Buttons -->
            <div class="top-controls">
                <a href="index.php" class="btn-back"><i class="fa-solid fa-arrow-left"></i></a> <!-- Arrow Icon -->
                <a href="edit.php?id=<?= $product['id'] ?>" class="btn-edit-blue">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">: <?= htmlspecialchars($product['vehicle_type']) ?></span>
            </div>
             <div class="detail-row">
                <span class="detail-label">Harga</span>
                <span class="detail-value">: Rp. <?= number_format($product['price_min'], 0, ',', '.') ?></span>
            </div>

            <!-- Description Centered Below -->
            <div class="description-box">
                <span class="description-title"><?= htmlspecialchars($product['name']) ?></span>
